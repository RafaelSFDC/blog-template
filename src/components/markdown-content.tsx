...
const styles = {
  h1: "leading-[1.08] tracking-tight text-balance font-extrabold mb-6 text-4xl text-foreground",
  h2: "leading-[1.08] tracking-tight text-balance font-extrabold mb-4 text-3xl text-foreground",
  ...
  li: "leading-relaxed",
  blockquote:
    "my-4 border-l-4 border-primary pl-4 italic text-muted-foreground",
