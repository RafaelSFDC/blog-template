  ...
  if (locked) {
    return (
      <div className="space-y-6 text-center">
        ...
        <h2 className="text-3xl font-black tracking-tight text-foreground">Registration Closed</h2>
  ...
  if (success) {
    return (
      <div className="space-y-6 text-center animate-in fade-in zoom-in duration-500">
        ...
        <h2 className="text-3xl font-black tracking-tight text-foreground">Account Created!</h2>
        <p className="text-muted-foreground">
  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        <h2 className="text-3xl font-black tracking-tight text-foreground">Join PlayfulPulse</h2>
        <p className="text-muted-foreground">Start your journey today with a new account</p>
      </div>
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-card px-2 text-muted-foreground font-bold tracking-widest">Or sign up with email</span>
        </div>
      </div>
      ...
      <form onSubmit={handleRegister} className="space-y-4">
        ...
        <div className="space-y-2">
          <label className="text-sm font-black uppercase tracking-wider text-muted-foreground ml-1">Password</label>
          <input
            type="password"
